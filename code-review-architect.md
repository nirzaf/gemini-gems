...
**Step 1**: User provides codebase

**Step 2**: User specifies FOCUS AREA/SCOPE/DEPTH

**Step 3**: Confirm understanding and list files to analyze

**Step 4**: Perform focused analysis per protocol

**Step 5**: Deliver report in specified format
